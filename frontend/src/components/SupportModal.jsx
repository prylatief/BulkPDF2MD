...
export default function SupportModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Card */}
      <div className="relative bg-[#0b0c13] border border-emerald-900/40 rounded-2xl max-w-md w-full p-6 text-center shadow-[0_0_50px_rgba(0,230,118,0.15)] animate-in fade-in zoom-in-95 duration-200 z-10">
