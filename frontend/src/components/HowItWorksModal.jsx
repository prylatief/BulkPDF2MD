...
export default function HowItWorksModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-zinc-950/30 border border-white/10 rounded-2xl max-w-lg w-full p-6 shadow-[0_0_80px_rgba(0,0,0,0.6),_0_0_40px_rgba(0,230,118,0.08)] backdrop-blur-2xl animate-in fade-in zoom-in-95 duration-200 z-10 overflow-hidden group">
